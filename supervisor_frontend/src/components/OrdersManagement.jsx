...
const OrderManagement = () => {
    ...
    const OrderStatusBadge = ({ status }) => {
        ...
        return <Badge bg={statusMap[status]?.bg || 'secondary'}>{statusMap[status]?.text || status}</Badge>;
    };
    ...
    if (loading) return <div className="text-center my-5"><Spinner animation="border" /> Loading orders...</div>;
